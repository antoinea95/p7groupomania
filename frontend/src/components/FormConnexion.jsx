...
const { errors } = formState;
    ...
    return (
        ...
        <div className="form--container">
            ...
            <form onSubmit={ isLogin ? handleSubmit(onLogin) : handleSubmit(onSignUp)}  className='form--connexion'>

                {!isLogin && 
                <>
                <div className="form--connexion__inputBloc">
                    <label htmlFor='firstName' className='form--connexion__label'><i className="fa-solid fa-face-smile"></i></label>
                    <input
                        aria-required='true'
                ...
                <small className="form--connexion__error">{errors.firstName?.message}</small> 
                </>
                }

                <div className="form--connexion__inputBloc">

                    <label htmlFor='email' className='form--connexion__label'><i className="fa-solid fa-at"></i></label>
                    <input 
                        aria-required='true'
                        className='form--connexion__input'
                        type='email' 
                ...
                <small className='form--connexion__error'>{errors.email?.message}</small>

                <div className="form--connexion__inputBloc">

                    <label htmlFor='password' className='form--connexion__label'><i className="fa-solid fa-key"></i></label>
                    <input 
                        aria-required='true'
                        className='form--connexion__input'
                        type='password' 
                ...
                <small className='form--connexion__error'>{errors.password?.message}</small>



                {!isLogin ? <button type="submit" className="form--connexion__submit"> Créer un compte </button> :
                <button type="submit" className='form--connexion__submit'> Se connecter </button>}
